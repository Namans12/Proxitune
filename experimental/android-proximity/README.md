# ProxiTune Android Proximity Prototype

This is the archived sensor companion for the Windows ProxiTune controller.
...
Open this directory in Android Studio, let Gradle sync, and run the
